...
user_db_file_location = 'dbname="postgres",user="postgres",password="abcd",host="postgres",port="5432"'
note_db_file_location = 'dbname="postgres",user="postgres",password="abcd",host="postgres",port="5432"'
image_db_file_location = 'dbname="postgres",user="postgres",password="abcd",host="postgres",port="5432"'
...
def delete_user_from_db(id):
    ...
    _conn = psycopg2.connect(image_db_file_location)
    _c = _conn.cursor()
